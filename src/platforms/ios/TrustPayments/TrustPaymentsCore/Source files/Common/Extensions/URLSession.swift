...
private extension URLSession {
    ...
    func process(_ data: Data?, _ urlResponse: URLResponse?, _ error: Error?, for request: NetworkRequest) -> DataResult {
        ...
        guard defaultAcceptableStatusCodes.contains(httpURLResponse.statusCode) else {
            ...
            TrustPayments.instance.monitoringManager.log(severity: .error, message: "Network error: \(httpURLResponse.statusCode)", additionals: ["siteReference": request.urlRequest.httpBody.jwt()?.siteReference])
