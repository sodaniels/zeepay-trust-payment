...
final class PickFontCell: BaseViewCell {
    ...
    func setupCell(row: StyleManagerInitializationViewModel.UIFontRow) {
        titleLabel.text = row.title
        fontLabel.text = row.font.familyName + .space + row.font.fontName
    }
}

extension PickFontCell: ViewSetupable {
